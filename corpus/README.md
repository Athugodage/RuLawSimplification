...
**[Unfiltered corpus](https://github.com/Athugodage/RuLawSimplification/blob/main/corpus/unfiltered_corpus.zip)** - Unfiltered legal corpus. Contains almost 3000 pairs of original doc and its comment that were available on rg.ru (Российская Газета). Also available on Kaggle - https://www.kaggle.com/datasets/athugodage/russian-legal-text-parallel-corpus
